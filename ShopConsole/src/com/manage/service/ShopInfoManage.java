...
public class ShopInfoManage {
	public static final List<ShopInfo> list(ShopInfo shop, int offset, int limit){
		...
		if(params.size() == 0){
			...
			shops = ShopInfo.dao.paginate(offset, limit, "select *", where.toString(), params.toArray());
		}
